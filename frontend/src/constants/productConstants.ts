export enum ProductConstants {
    ...
    PRODUCT_LIST_ADMIN_REQUEST = "PRODUCT_LIST_ADMIN_REQUEST",
    PRODUCT_LIST_ADMIN_SUCCESS = "PRODUCT_LIST_ADMIN_SUCCESS",
    PRODUCT_LIST_ADMIN_FAIL = "PRODUCT_LIST_ADMIN_FAIL",
    ...
    PRODUCT_LIST_SEARCH_REQUEST = "PRODUCT_LIST_SEARCH_REQUEST",
    PRODUCT_LIST_SEARCH_SUCCESS = "PRODUCT_LIST_SEARCH_SUCCESS",
    PRODUCT_LIST_SEARCH_FAIL = "PRODUCT_LIST_SEARCH_FAIL",
